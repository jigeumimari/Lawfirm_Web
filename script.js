...
body {
  ...
  background:
    radial-gradient(1200px 600px at 10% -10%, #740097, transparent), /* top-left glow */
    radial-gradient(1200px 600px at 90% 110%, #740097, transparent), /* bottom-right glow */
    var(--bg);
  color: var(--text);
}
...
/* ---- Messages ---- */
.threads { list-style: none; padding: 0; margin: 0; display: grid; gap: 8px; max-height: 400px; overflow: auto }
.thread { padding: 10px; border: 1px solid rgba(255,255,255,.06); border-radius: 10px; cursor: pointer; background: #0f1634 }
...
.msg .bubble { background: #10183a; border: 1px solid rgba(255,255,255,.06); padding: 8px 10px; border-radius: 12px; max-width: 70% }
